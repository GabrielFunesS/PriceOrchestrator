...
namespace PriceOrchestrator.Api.Data.Migrations
{
    ...
    [Migration("20260604173749_ChangePriceChangeRequestStatusToInt")]
    partial class ChangePriceChangeRequestStatusToInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PriceOrchestrator.Api.Entities.ProductCurrentPrice", b =>
                {
                    ...
                    b.HasIndex("LastPriceChangeRequestId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PriceOrchestrator.Api.Entities.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductId", "Warehouse")
                        .IsUnique();

                    b.ToTable("ProductStock", (string)null);
                });

            modelBuilder.Entity("PriceOrchestrator.Api.Entities.Promotion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PriceOrchestrator.Api.Entities.ProductCurrentPrice", b =>
                {
                    b.HasOne("PriceOrchestrator.Api.Entities.PriceChangeRequest", "PriceChange")
                        .WithOne("CurrentPrice")
                        .HasForeignKey("PriceOrchestrator.Api.Entities.ProductCurrentPrice", "LastPriceChangeRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
